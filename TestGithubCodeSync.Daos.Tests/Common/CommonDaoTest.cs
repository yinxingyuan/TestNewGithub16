...
/*add customized code between this region*/
namespace TestGithubCodeSync.Daos.Tests.Common
{
	...
	where TDdlBuilder : DdlBuilder, new()
	{
		...
		public void BasicSetUp()
		{
			...
			DaoFactory.Instance.ConnectionStringBuilder = new SqlCeConnectionStringBuilder("TestGithubCodeSync.Entities", baseDirectory, null);
