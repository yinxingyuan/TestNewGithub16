...
using TestGithubCodeSync.Daos;
using TestGithubCodeSync.Services;
/*add customized code between this region*/
/*add customized code between this region*/
namespace TestGithubCodeSync.WebApi
{
    ...
    public class WebApiApplication : HttpApplication
    {
        protected void Application_Start()
        {
            ...
            string connectionString = ConfigurationManager.ConnectionStrings["TestGithubCodeSync"].ConnectionString;
